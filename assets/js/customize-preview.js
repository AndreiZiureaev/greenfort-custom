...
(function( $ ) {
	...
	// Custom header descriptions.
	let number_of_choices = 2;
	for ( let i = 1; i <= number_of_choices; i++ ) {
		wp.customize( 'description_' + i, function( value ) {
			value.bind( function( to ) {
				$( '.greenfort-choice-link:nth-child(' + i + ') .greenfort-choice-description' ).html( to );
			});
		});
	}
